...
newBeneficiaries.toselectBeneficiary()
newBeneficiaries.toselectConvertAndPay()
newBeneficiaries.toenterCovertAndPayAmount(newTest.amount_to_send)
newBeneficiaries.toContinue()
newFunction.scrollToView(newBeneficiaries.purposeOfPaymentSelection)
newBeneficiaries.toEnterPurposeOfPayment()
newBeneficiaries.toSelectPurposeOfPayment()
newBeneficiaries.tosendToBankAccount()
