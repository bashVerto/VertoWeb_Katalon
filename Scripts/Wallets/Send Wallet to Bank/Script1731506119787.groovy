...
newWallet.toSendMoney()
newWallet.toWtB_ccySelect(newTest.eur)
newWallet.toWtBSelectEUR()
newWallet.toWtB_enterAmnt(newTest.amnt)
newWallet.toWtBContinueStep()
newWallet.towtB_ListRefresh()					//Refreshing the list because of the bug in the flow
newWallet.toWtB_SearchBene(newTest.beneName)
newWallet.toWtB_SelectBene()
newWallet.toWtB_SearchPOP(newTest.wtbPOP)
newWallet.toWtB_SelectPOP()
newWallet.toSendtoBank()
newWallet.toWtBAuth()
newWallet.toWtBAuthContinue()
newWallet.toTrxStatus()
